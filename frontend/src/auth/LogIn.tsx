...
import { LogInResponse } from 'models/Entities';
...
function LogIn() {
	...
	let onLogIn = () => {
		update(() => {
			...
			// ! This is only secure over HTTPS, DO NOT SEND USER CREDENTIALS UNENCRYPTED in production code !
			...
			.then(res => {
				...
				appState.userAdmin = data.isAdmin;
